...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default='./saved_models/byol_local_MD/byol_local_MD_global_model_r_99_f0000001.pth', type=str, help="Path to pre-trained model (e.g. model-10.pt)")
